...
class DatabaseManager:
    ...
    def create_project(self, name: str, notes: Optional[str] = None, description: Optional[str] = None) -> int:
        ...
        Args:
            name: Project name
            notes: Project notes (legacy parameter)
            description: Project description (alternative to notes)
        
        Returns:
            Project ID
        """
        # Use description if provided, otherwise use notes
        project_notes = description if description is not None else notes
